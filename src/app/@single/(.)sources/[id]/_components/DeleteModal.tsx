...
export default function DeleteModal({ _id, title, handleCloseViewModal, deleteSource }: DeleteModalProps) {
                                ...
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <div className="mt-2">
                                        <p className="text-sm text-gray-500">
                                            Are you sure you want to delete <span className="font-semibold">{!!title ? title : ('this source')}</span>? This cannot be undone.
                                        </p>
                                    </div>
