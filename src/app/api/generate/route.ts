	...
	try {
		...
		const formatSettings = async (settings: any) => {
			...
			if (!!formula) {
				...
				settingsString += `
				### The response should strictly follow this formula. Do not repeat these instructions in your response. Only use them as a guide to structure your response ###\n
