            ...
            <div className="w-full flex flex-col gap-4 prose">
                ...
                <div className="flex flex-col gap-2 mb-6">
                    <div className="pb-2 border-b border-gray-200">
                        ...
                        <p>The &ldquo;think about&ldquo; section gives Apprentice a cue to think through how it should respond to a prompt before actually generating a response.</p>
                    </div>
                    {!!editThinkAbout ? (
                        <TextareaAutosize
                ...
                <div className="flex flex-col gap-2 mb-6">
                    <div className="pb-2 border-b border-gray-200">
                        ...
                        <p>By asking Apprentice to outline it&lsquo;s response before it begins generation, you increase the potential for a high-quality response. Especially with complicate responses.</p>
                    </div>
