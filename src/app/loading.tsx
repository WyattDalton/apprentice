                ...
                <div className='grid grid-cols-6 auto-rows-max gap-2'>
                    <div className='col-span-full'>
                        <div className='prose'>
                            ...
                            <p className="">Give Apprentice superpowers! Teach him to use a specific style of voice, learn specific information about your industry, and create content by following exact formulas</p>
                        </div>
                    </div>
                    ...
                    <div className='!bg-neutral-50 p-4 rounded-md flex flex-col gap-2 col-span-full md:col-span-3 xl:col-span-2'>
                        <h3 className='text-xl text-gray-700 m-0'>Style Library</h3>
                        <p className='text-gray-500 mb-2'>Create your own styles and style of voice.</p>
                        <div
                            className={`mt-auto no-underline bg-gray-700 text-white py-1 px-4 rounded-md max-w-max flex justify-center items-center text-lg`}>
                            Go to style library
                        </div>
