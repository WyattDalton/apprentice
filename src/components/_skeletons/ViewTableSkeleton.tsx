...
export default function ViewTableSkeleton() {
    return (
        <div className="relative overflow-x-auto shadow-md rounded-lg m-4 bg-white">

            <div role="status" className="flex justify-between items-center p-6 bg-white dark:bg-gray-800 dark:text-white">
                <div className="h-2.5 w-12 bg-gray-300 rounded-full dark:bg-gray-600"></div>
                <div className="h-2.5 w-12 bg-gray-300 rounded-full dark:bg-gray-600"></div>
            </div>
